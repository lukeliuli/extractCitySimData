...
def gen_samples_meter(input_csv,output_dir,laneIds,redlightConfig,start_of_lane_coords,end_of_lane_coords):
    ...
    for laneId in laneIds:
        ...
        for col in ['carCenterXft', 'carCenterYft', 'headXft', 'headYft', 'tailXft', 'tailYft']:
            lane_data[col.replace('ft', '')] = lane_data[col] * ft_to_m



        # 假设速度单位是Miles per Hour，转换为米/秒
        mph_to_mps = 0.44704
        lane_data['speed'] = lane_data['speed'] * mph_to_mps

       
        # 删除原始的英尺单位列
        lane_data = lane_data.drop(columns=['carCenterXft', 'carCenterYft', 'headXft', 'headYft', 'tailXft', 'tailYft'])
...
if 1:
    ...
    file_path = 'E:\myData\IntersectionA-01.csv'
    output_dir = 'IntersectionA-01-trainsamples'
...
laneId,start_of_lane_m,end_of_lane_m
7,[ 3.99644951 63.01769865],[53.30001614 61.79772985]
6,[ 4.20678896 59.31572436],[53.13174459 57.71714455]
5,[ 4.24885685 55.9082253 ],[53.04760881 54.77239228]
...
pixel coordinates:
   start_of_lane_coordsNow = {
    ...
    gen_samples_meter(input_csv,output_dir,laneIds,redlightConfigNow,start_of_lane_coordsNow,end_of_lane_coordsNow)
    '''
