...
def model_with_uncertainty(unit=256, layNum=10, batch_size=64, epochs=50, test_size=0.9, mc_samples=100):
...
if __name__ == "__main__":
    ...
    model_with_uncertainty(unit=256, layNum=10, batch_size=64, epochs=50, test_size=0.9, mc_samples=10)